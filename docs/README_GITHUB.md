...
El portafolio carga dinámicamente los proyectos desde `data/projects.json`:
...
- El sitio usa **Mobile-First** approach
- Tipografía fluida con `clamp()` para mejor adaptabilidad
- Animaciones con CSS y JavaScript para mejor UX
- SEO optimizado con meta tags semánticos
- Formulario de contacto preparado para integración backend
